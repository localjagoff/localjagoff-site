...
export function makeFreePromoPack(product, options = {}) {
  ...
  return {
    ...
    instagram_caption: `${instagramOpen} ${hookTwo}\n\n${instagramClose}\n\n${formatPromoHashtags(
      makePromoHashtags(cleanProduct)
    )}`,
    tiktok_caption: `${tiktokOpen} ${hookThree} ${tiktokClose} ${formatPromoHashtags(
    ...
    youtube_shorts_description: `${shortsOpen} ${name} from Local Jagoff. ${attitudeDescriptor}, no boring gear. ${shortsClose}`,
