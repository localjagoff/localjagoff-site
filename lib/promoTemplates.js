...
function promoBundleHelper() {
  return [
    "Posting bundles:",
    "Facebook Bundle: Facebook Post + Facebook tracked link.",
    "Instagram Bundle: Instagram Caption + Instagram tracked link.",
    "TikTok Bundle: TikTok Caption + TikTok tracked link.",
    "YouTube Shorts Bundle: YouTube Shorts Title + YouTube Shorts Description + YouTube Shorts tracked link.",
  ].join("\n");
}
...
export function makeFreePromoPack(product, options = {}) {
  ...
  const pack = {
    ...
    warnings: [
      ...
      "CTA now includes first-comment, direct product link, UTM tracked social links, and posting bundle guidance.",
