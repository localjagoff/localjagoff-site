...
const SHIPPING_RATE_VERSION = 'us-standard-2026-09-13';
...
const SHIPPING_PRODUCTS = Object.freeze({
  471744647: 'tees', 471744585: 'tees', 471744477: 'tees', 471744283: 'tees',
...
const SHIPPING_CHARGE = "US Standard Shipping is calculated from the items and quantities in your cart, with no added shipping markup. Hats ship separately from apparel. The shipping charge is shown before payment.";
