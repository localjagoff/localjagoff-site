...
// Removal-only compatibility with the last approved snapshot. Never extend its age.
// The retired ID is not sellable; this preserves the remaining catalog during refresh.
const PREVIOUS_POLICY='[428821578,428851513,428851608,428851698,428851907,428980566,428982889,428983169,429208592,429536493,429728777,429821634,430697388,430964873]';
