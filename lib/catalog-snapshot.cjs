...
// Keep unaffected products visible while the replacement Snapback is refreshed atomically.
// Never extend the source age or expose a partially refreshed cycle.
const PREVIOUS_POLICY='[428821578,428851513,428851608,428851698,428851907,428980566,428982889,428983169,429208592,429536493,429728777,429821634,430964873,471744283,471744585,471744647,471950476,473689891,473808088,473808622]';
