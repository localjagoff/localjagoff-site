...
export default function Review(){
  ...
  return <div className={styles.page}><Head><title>Review Your Gear | Local Jagoff</title><meta name="robots" content="noindex,nofollow"/><meta name="referrer" content="no-referrer"/></Head><Navbar/><main id="main-content" tabIndex={-1} className={styles.main}>
