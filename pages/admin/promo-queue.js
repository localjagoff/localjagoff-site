    ...
    <div className="page">
      ...
      <main className="wrap">
        <header className="hero">
          ...
          <a href="/admin/promo-generator">Back to Generator</a>
        </header>
