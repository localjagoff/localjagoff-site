...
export default function PromoHealth() {
  ...
  const totalProblems = queueProblems.length + savedProblems.length + bankProblems.length + performanceProblems.length;
    ...
    <div className="page">
      ...
      <main className="wrap">
        <header className="hero">
          ...
          <h1>Promo Health</h1>
          <p>Check the browser-stored promo queue, saved library, Product Bank, Performance, and no-repeat memory. Repair old or malformed promo data before it causes weird copy/export behavior.</p>
        </header>
        ...
        <section className={`statusPanel ${totalProblems === 0 ? "good" : "warn"}`}>
          ...
          <p>{totalProblems === 0 ? "Queue, saved library, Product Bank, and Performance data look usable." : "Use the repair buttons below to clean up old browser-stored promo data."}</p>
        </section>
        ...
        <section className="grid">
          ...
          <article className="panel">
            <h2>Health Report</h2>
            <p className="muted">Exports a JSON report with current counts, issues, queue, saved library, Product Bank, Performance, and memory.</p>
