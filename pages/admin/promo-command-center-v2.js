...
export default function PromoCommandCenterV2() {
  ...
  const generateFreePromo = () => {
    setError("");
    if (!selectedProduct) return setError("Pick a product first.");
    const pack = makeFreePromoPack(selectedProduct, { mode, platform, goal, toneIntensity, notes });
    showPack(pack, "Free Template");
  };
      ...
      <main className="wrap">
        <header className="hero">
          <div>
            ...
            <p>Generate Local Jagoff posts, save promo packs, queue campaign ideas, and switch platform views without regenerating.</p>
          </div>
        ...
        {activeSection === "create" && (
          <section className="dashboardGrid">
            <div className="panel controls">
              ...
              <div className="field"><label>Goal</label><input value={goal} onChange={(e) => setGoal(e.target.value)} placeholder="sell_product, product_drop, brand_awareness..." /></div>
              <div className="field full"><label>Extra notes</label><textarea value={notes} onChange={(e) => setNotes(e.target.value)} placeholder="Example: make it more 724, less salesy, mention hoodie season, avoid Steelers references, etc." /></div>
            ...
            <aside className="sidePanel">
              ...
              <div className="costCard"><p className="miniKicker">DISPLAY FILTER</p><h3>{PLATFORM_LABELS[platform]}</h3><p>Results start with this platform, but you can switch views after generating.</p></div>
