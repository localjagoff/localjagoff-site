...
export default function PromoWeekBuilderRedirect() {
  useEffect(() => {
  ...
  return (
    <div className="redirectPage">
      <Head>
        <title>Redirecting to Queue</title>
        <meta name="robots" content="noindex,nofollow" />
      </Head>
      <main>
        <p>Week Builder has been folded into the Queue workflow.</p>
        <a href="/admin/promo-queue">Open Queue</a>
      </main>
      <style jsx>{`
