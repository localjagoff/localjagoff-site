...
export default function PromoCommandCenterRedirect() {
  useEffect(() => {
    window.location.replace("/admin/promo-generator");
  }, []);
  ...
  return (
    <div className="redirectPage">
      ...
      <main>
        <p>Promo Command Center has been consolidated into Promo Studio.</p>
