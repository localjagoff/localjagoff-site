...
export default function PromoInsightsRedirect() {
  useEffect(() => {
    window.location.replace("/admin/promo-performance?view=insights");
  }, []);

  return (
    <div className="redirectPage">
      <Head>
        <title>Redirecting to Performance</title>
        <meta name="robots" content="noindex,nofollow" />
      </Head>
      <main>
        <p>Insights have been consolidated into Performance.</p>
        <a href="/admin/promo-performance?view=insights">Open Performance</a>
      </main>
      <style jsx>{`
        ...
        main{width:min(460px,100%);border:1px solid rgba(255,230,0,.25);border-radius:24px;padding:26px;background:rgba(13,13,13,.94);text-align:center}
